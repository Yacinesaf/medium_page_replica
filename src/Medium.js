  ...
  return (
    <div>
      ...
      <Grid container justify='center'>
        <Grid item xl={10} lg={9} md={10} sm={11} xs={11}>
          <Grid container>
            <Grid item sm={8} xs={12} style={{ paddingTop: smDown ? 0 : 60, paddingRight : 40 }}>
              ...
              <div style={{ paddingBottom: 15 }}>
                {bigTitles.map((x, i) => (
                  <Grid container key={i} style={{ paddingTop: 20 }}>
                    <Grid item xs={10} md={9} style={{ paddingRight: 10 }}>
                      <Typography style={{ fontWeight: 550, fontSize: 18 }}>{x}</Typography>
                      <Typography variant='body2' style={{ color: 'grey', paddingBottom: 10, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{subtitle[i]}</Typography>
                      <Typography variant='body2' style={{ paddingBottom: 5 }}>{captions[i]}</Typography>
                      <Grid item style={{ display: 'flex' }}>
                        <div style={{ display: 'flex', flexGrow: 1 }}>
                          <Typography variant='body2'>{dateTime[i]} </Typography>
                          <StarIcon style={{ fontSize: 15, color: 'grey', paddingLeft: 5, paddingTop: 2 }} />
                        </div>
                        <BookmarkBorderIcon style={{ fontSize: 20 }} />
                      </Grid>
                    </Grid>
                    <Grid item xs={2} md={3} style={{ paddingLeft: 'calc(25% - 140px)' }}>
                      <div
                        style={{ width: "100%", height: '100%', backgroundImage: `url(${imagesList[i]})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
                      </div>
                    </Grid>
                  </Grid>
                ))}
            ...
            <Grid item lg={4} xl={4} md={4} sm={12} xs={12} style={{ paddingLeft: 30, paddingRight: 150 }}>
